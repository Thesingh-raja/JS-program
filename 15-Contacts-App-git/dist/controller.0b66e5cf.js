...
var ContactContainerView = /*#__PURE__*/function () {
  ...
  _createClass(ContactContainerView, [{
    ...
    value: function render(data) {
      ...
      var html = _classPrivateMethodGet(this, _generateHTMLString, _generateHTMLString2).call(this); // console.log(html);
    ...
    value: function addDeleteListener(handler) {
...
function _generateHTMLString2() {
  ...
  if (Array.isArray(data)) {
    data.forEach(function (contact) {
      html += _classPrivateMethodGet(_this2, _generatCardContactHTML, _generatCardContactHTML2).call(_this2, contact); // console.log(html);
    });
    return html;
  }
}
...
var AddContactView = /*#__PURE__*/function () {
  ...
  _createClass(AddContactView, [{
    ...
    key: "addContactSubmitListener",
    value: function addContactSubmitListener(handler) {
...
var controlAddContact = function controlAddContact(event) {
  ...
  var newContact = new _model.ContactPerson(Name, Email, Phone);
...
var handleSearch = function handleSearch(e) {
  ...
  location.hash = "#q=".concat(query); // SearchView.clearForm();
};
  ...
  if (Array.isArray(list)) {
    list.forEach(function (contact) {
      if (contact.name.includes(query) || contact.phone.toString().includes(query) || contact.email.includes(query)) {
        results.push(contact); // console.log(results);
      }
    });
  }
...
var controlHashChange = function controlHashChange() {
  ...
  } else _ContactContainerView.default.render(getContactsFromLS());
};
...
var init = function init() {
  _AddContactView.default.addContactSubmitListener(controlAddContact);

  _ContactContainerView.default.addDeleteListener(controlContactDelete);
...
init();
},{"./model":"src/model.js","./Views/ContactContainerView":"src/Views/ContactContainerView.js","./Views/AddContactView":"src/Views/AddContactView.js","./Views/SearchView":"src/Views/SearchView.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
